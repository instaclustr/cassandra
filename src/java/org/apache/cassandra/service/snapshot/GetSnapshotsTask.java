...
public class GetSnapshotsTask implements Callable<List<TableSnapshot>>
{
    ...
    public GetSnapshotsTask(Supplier<Iterable<TableSnapshot>> snapshotsSupplier,
    ...
    private List<TableSnapshot> getWithRemoval()
    {
        ...
        if (!notExistingAnymore.isEmpty())
            new ClearSnapshotTask(notExistingAnymore::contains, snapshotsSupplier, false).run();
