...
public class MessagingService extends MessagingServiceMBeanImpl implements MessageDelivery
{
    ...
    public enum Version
    {
        ...
        // TCM, index hints
        VERSION_60(14),
        // negotiable internode compression framing (Framing.COMPRESSED); serialization unchanged from VERSION_60
        VERSION_70(15);
    ...
    public static final int VERSION_70 = 15; // negotiable internode compression framing; serialization unchanged from VERSION_60
    public static final int minimum_version = VERSION_40;
    public static final int maximum_version = VERSION_70;
    ...
    {
        return DatabaseDescriptor.getStorageCompatibilityMode().isBefore(5) ? Version.VERSION_40 : Version.VERSION_70;
    }
