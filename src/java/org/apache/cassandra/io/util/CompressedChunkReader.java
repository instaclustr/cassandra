...
public abstract class CompressedChunkReader extends AbstractReaderFileProxy implements ChunkReader
{
    ...
    final double crcCheckChance;

    protected CompressedChunkReader(ChannelProxy channel, CompressionMetadata metadata, double crcCheckChance)
    {
    ...
    public static class Standard extends CompressedChunkReader
    {
        ...
        public Standard(ChannelProxy channel, CompressionMetadata metadata, double crcCheckChance)
        {
            super(channel, metadata, crcCheckChance);
    ...
    public static class Mmap extends CompressedChunkReader
    {
        ...
        public Mmap(ChannelProxy channel, CompressionMetadata metadata, MmappedRegions regions, double crcCheckChance)
        {
            super(channel, metadata, crcCheckChance);
