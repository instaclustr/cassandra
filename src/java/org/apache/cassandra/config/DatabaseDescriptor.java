...
public class DatabaseDescriptor
{
    ...
    */
    ...
    public static int getMaximumReferencedIndexesForNonPartitionRestrictedQueryWarnThreshold()
    {
        return conf.sai_sstable_indexes_per_query_warn_threshold;
    }

    public static int getMaximumReferencedIndexesForNonPartitionRestrictedQueryFailThreshold()
    {
