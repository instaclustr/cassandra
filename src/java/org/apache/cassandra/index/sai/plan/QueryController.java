...
public class QueryController
{
    ...
    private void maybeTriggerGuardrails(QueryViewBuilder.QueryView queryView)
    {
        ...
        if (Guardrails.maximumReferencedIndexesWithNonParitionRestrictedQuery.failsOn(referencedIndexes, null))
        {
        ...
        else if (Guardrails.maximumReferencedIndexesWithNonParitionRestrictedQuery.warnsOn(referencedIndexes, null))
        {
