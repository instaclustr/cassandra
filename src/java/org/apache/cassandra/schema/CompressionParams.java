...
public final class CompressionParams
{
    ...
    public Map<String, String> asMap(boolean forCql)
    {
        if (!isEnabled())
        ...
        if (forCql)
            options.put(CHUNK_LENGTH, new DataStorageSpec.IntKibibytesBound(Long.parseLong(chunkLengthInKB()), DataStorageSpec.DataStorageUnit.KIBIBYTES).toString());
        else
