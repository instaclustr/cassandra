...
public class ColumnConstraints implements ColumnConstraint<ColumnConstraints>
{
    ...
    {
        @Override
        public void serialize(ColumnConstraints columnConstraints, DataOutputPlus out, int version) throws IOException
        {
            out.writeInt(columnConstraints.getConstraints().size());
