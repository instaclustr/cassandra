...
public final class Guardrails implements GuardrailsMBean
{
    ...
    public static final MaxThreshold maximumReferencedIndexesWithNonParitionRestrictedQuery =
    new MaxThreshold("maximum_referenced_indexes_for_non_paritition_key_restricted_query",
    ...
    @Override
    public boolean getNonPartitionRestrictedIndexQueryEnabled()
    {
