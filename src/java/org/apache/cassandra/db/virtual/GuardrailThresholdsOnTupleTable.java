...
public class GuardrailThresholdsOnTupleTable extends AbstractMutableVirtualTable
{
    public static final String TABLE_NAME = "thresholds_on_tuple";

    public static final String NAME_COLUMN = "name";
    public static final String VALUE_COLUMN = "value";

    public GuardrailThresholdsOnTupleTable()
    {
    ...
    public GuardrailThresholdsOnTupleTable(String keyspace)
    {
