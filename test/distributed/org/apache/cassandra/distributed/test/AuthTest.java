...
public class AuthTest extends TestBaseImpl
{
    ...
    private void waitForExistingRoles(IInvokableInstance instance) throws Exception
    {
        await(30, 1, () -> instance.callOnInstance(CassandraRoleManager::hasExistingRoles));
    }
    ...
    private void await(int atMost, int interval, Callable<Boolean> callable) throws Exception
    {
        for (int i = 0; i < atMost; i += interval)
        {
            if (callable.call())
                return;
