...
public class SnapshotTest extends TestBaseImpl
{
    ...
    public void testSimpleSnapshot() throws Throwable
    {
                                             ...
                                             .start()))
        {
            ...
            cluster.schemaChange(withKeyspace("create table %s.tblconstraints (id int primary key, x int check x > 100 and x < 200 and NOT_NULL(x), v text check LENGTH(v) > 10)"));
