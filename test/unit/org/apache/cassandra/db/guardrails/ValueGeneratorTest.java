...
public class ValueGeneratorTest
{
    ...
    public void testValueGenerator()
    {
        ...
        Boolean[] defaultBooleans = booleanGenerator.generate();
        assertNotNull(defaultBooleans);
        assertEquals(10, defaultBooleans.length);

        Boolean[] tenBooleans = booleanGenerator.generate(10);
        assertEquals(10, tenBooleans.length);
        for (int i = 0; i < 10; i++)
            assertEquals(true, tenBooleans[i]);
    }
