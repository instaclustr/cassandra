...
/**
 * CQL-driven regression test for CASSANDRA-21390 ("MemtableReclaimMemory AssertionError:
        ...
        for (int seed = 0; seed < 50; seed++)
        {
            ...
            for (int i = 0; i < 40; i++)
            {
                ...
                .as("memtable on-heap owns went NEGATIVE during overwrite/delete churn (seed=%d, mutation=%d) " +
                    "— the memtable reported releasing more on-heap memory than it allocated (CASSANDRA-21390)",
                    seed, i)
