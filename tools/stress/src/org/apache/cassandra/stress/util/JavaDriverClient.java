...
public class JavaDriverClient
{
    ...
    {
        this(settings, Collections.singletonList(host), port, new EncryptionOptions.ClientEncryptionOptions().applyConfig());
    }

    public JavaDriverClient(StressSettings settings, List<String> hosts, int port)
    {
        this(settings, hosts, port, new EncryptionOptions.ClientEncryptionOptions().applyConfig());
    }
